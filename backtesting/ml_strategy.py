...
class MLStrategy(CtaTemplate):
    ...
    def __init__(self, cta_engine, strategy_name, vt_symbol, setting):
        ...
        self.am = ArrayManager_m()
        self.amn = ArrayManager_m()
        self.is_macon_change = 0
        self.count = 0
        self.res_dic = {'datetime': [], 'close': [], 'signal': [], 'pos': [], 'profit': [], 'cost': []}
        self.first = 1
        self.pos_1 = 0
    ...
    def save_info(self, bar: BarData):
        ...
        if self.first:
            ...
            # self.res_dic['profit'].append((self.amn.close[-1]-self.amn.open[-1])*self.pos)
