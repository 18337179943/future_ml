...
def run_optimize_total_mltest():
    ...
    for i in range(4, 13):
        for j in range(2, 7):
            for k in range(10, 11, 3):
                try:
                    params = {"trade_type": 24, "atr_n_mod24": i, 'atr_dev_mod24': j, 'atr_rate_mod24': k/10, 'atr_dynamic': 1, 'is_leverage': 0}
                    ...
                    print(train_score, val_score, target, i, j, k, '-----------')
                except:
