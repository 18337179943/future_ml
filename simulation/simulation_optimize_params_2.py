...
def run_optimize_total_mltest():
    ...
    for i in range(4, 13):
        for j in range(7, 13):
            params = {"trade_type": 23, "atr_n_mod23": i, 'atr_dev_mod23': j, 'is_leverage': 0}
            val_score, _ = sbt.all_symbols_backtesting(symbol_li, startdate=datetime(2019, 5, 1), enddate=datetime(2020, 11, 1), y_pred_li=y_pred_li, params=params, target_type=target_type)
            ...
            if best_params['score'] < val_score:
                best_params['score'] = val_score
